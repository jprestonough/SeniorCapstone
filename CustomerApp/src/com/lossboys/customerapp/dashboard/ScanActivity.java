...
public class ScanActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * // Importing all assets like buttons, text fields inputItemID =
		 * (EditText) findViewById(R.id.ItemIdField); btnItemID = (Button)
		 * findViewById(R.id.btnItemID); scanErrorMsg = (TextView)
		 * findViewById(R.id.scan_error);
		 * 
		 * btnItemID.setOnClickListener(new View.OnClickListener() {
		 * 
		 * @Override public void onClick(View view) { String ItemID =
		 * inputItemID.getText().toString();
		 * 
		 ...
		 * 
		 * JSONObject scanJSON =
		 * CustomHTTP.makePOST("http://23.21.158.161:4912/get_item.php",
		 * nameValuePair);
		 * 
		 * if(scanJSON != null){ try { if(!scanJSON.isNull("Error")){
		 * scanErrorMsg.setText("Item does not exist."); }else{ Intent i = new
		 ...
		 * scanErrorMsg.setText("Lookup failed."); } } else
