...
/**
 * A list fragment representing a list of Carts. This fragment also supports
...
public class CartListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<CartListContent.Cart>(getActivity(),
				...
				android.R.id.text1, CartListContent.CARTS));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(CartListContent.CARTS.get(position).id);
	}
